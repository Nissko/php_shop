    ...
    <div>
        <div class="mb-4">
            <Link class="inline-block py-2 px-3 bg-sky-600 border border-sky-700 text-white"
                  :href="route('admin.product-groups.create')">Добавить</Link>
        </div>
        <div>
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tr v-for="productGroup in productGroupsData"
                    ...
                    <td class="px-6 py-4"><Link :href="route('admin.product-groups.show', productGroup.id)">{{ productGroup.title }}</Link></td>
